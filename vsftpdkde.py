...
def start_vsftpd():
    ...
    if result.returncode == 0:
        tray_icon.setIcon(QIcon('~/.local/share/icons/hicolor/48x48/icons_vsftpdkde/vsftpdkde_green.png'))
    else:
        tray_icon.setIcon(QIcon('~/.local/share/icons/hicolor/48x48/icons_vsftpdkde/vsftpdkde_red.png'))
...
app = QApplication([])
tray_icon = QSystemTrayIcon(QIcon('~/.local/share/icons/hicolor/48x48/icons_vsftpdkde/vsftpdkde_red.png'), parent=None)
tray_icon.show()
